...
export const scienceOptions: subjectOptions = {
  ...
  [performance.MEDIUM]: [
    'Quanto ao desenvolvimento dos conceitos de natureza e sociedade, de modo geral, **student** tem alcançado bons resultados sem maiores dificuldades, conceitos como identidade, direitos e deveres das crianças, descobrimento do Brasil, entre outros.',
  ...
  [performance.HIGH]: [
    ...
    'Em relação ao desenvolvimento dos conceitos de natureza e sociedade seu desempenho é excelente, compreendendo conceitos como identidade, direitos e deveres das crianças, família e escola.',
  ],
};
