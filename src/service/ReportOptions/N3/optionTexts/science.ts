...
export const scienceOptions: subjectOptions = {
  ...
  [performance.MEDIUM]: [
    'Quanto ao desenvolvimento dos conceitos de natureza e sociedade, de modo geral, **student** tem alcançadobons resultados sem maiores dificuldades, conceitos como identidade, direitos e deveres das crianças, descobrimento do Brasil, entre outros.',
