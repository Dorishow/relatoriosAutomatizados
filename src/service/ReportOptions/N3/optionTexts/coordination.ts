...
export const coordinationOptions: subjectOptions = {
  ...
  [performance.MEDIUM]: [
    'Quanto à sua coordenação motora, tem conseguido avançar e performar sem dificuldades até o momento.',
    ...
    'Em relação à sua coordenação motora, têm realizado as atividades e desempenhado sem dificuldades.',
  ],
  [performance.HIGH]: [
