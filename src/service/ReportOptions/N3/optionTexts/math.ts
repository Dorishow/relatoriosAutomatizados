...
export const mathOptions: subjectOptions = {
  ...
  [performance.HIGH]: [
    ...
    'Seu aprendizado quanto à matemática se desenvolve de modo abrangente e proveitoso, aplicando com facilidade os concentos apresentados em sala.',
    'Seu desenvolvimento do raciocício lógico matemático tem se desenvolvido de modo exemplar, não apresentando resistência ou dificuldade, aproveitando os conceitos apresentados em aula.',
  ],
};
