...
export const mathOptions: subjectOptions = {
  ...
  [performance.HIGH]: [
    ...
    'Seu desenvolvimento do raciocínio lógico matemático tem se desenvolvido de modo exemplar, não apresentando resistência ou dificuldade, aproveitando os conceitos apresentados em aula como sequência numérica, números vizinhos, contagem de pequenos grupos, entre outros.',
  ],
};
