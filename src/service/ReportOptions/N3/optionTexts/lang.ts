...
export const langOptions: subjectOptions = {
  [performance.LOW]: [
    ...
    'Em relação ao aprimoramento do código de linguagens, ainda apresenta dificuldade com algumas consoantes, mas de todo modo têm avançado com suas habilidades em identificar vogais e consoantes.',
